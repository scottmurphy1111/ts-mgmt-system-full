...
export const actions = {
	sendAgreement: async ({ request }) => {
		...
		const sendEmail = () => {
          ...
          <p>Welcome to TruckSuite! In order to get you started, please follow the steps to sign our Producer Agreement at this link: 
          <a href=${selectProducerAgreement(tsSalesRepId)}">My Producer Agreement</a>.<br />
